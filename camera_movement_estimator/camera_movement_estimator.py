...
def process_video_in_chunks(video_path, chunk_size=100):
    ...
    while cap.isOpened():
        ...
        if frame_count % chunk_size == 0:
            ...
            chunk_output_frames = camera_movement_estimator.draw_camera_movement(frames, camera_movement_per_frame)
            output_frames.extend(chunk_output_frames)
            frames = []
            gc.collect()
...
def main():
    ...
    output_frames = process_video_in_chunks(video_path)
